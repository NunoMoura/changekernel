...
CodeWiki supports bounded importers for SARIF, JUnit XML, LCOV, Cobertura, CycloneDX, SPDX, Pact, OpenAPI, and provider-check receipts. Compact immutable metadata enters the Change Trace while large or private bytes remain in their existing authority boundary.
