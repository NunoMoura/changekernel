...
**CodeWiki status** distinguishes Backend Build, Project Server, Runtime, provider broker, Run Process, Check Run Process, and Workbench health. It shows exact Domain Plugin, DSH profile and Plugin closure, upgrade qualification, active Run identities, cancellation, and recovery without presenting process availability as project acceptance.
