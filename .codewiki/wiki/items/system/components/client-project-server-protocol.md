...
Planning, Work integration, Review, completion, and protected-effect commands similarly bind exact stage subjects, current Gates, expected heads/tips, authority, and idempotency. Project Server derives resulting commits, trees, Trace operations, WorkState, and receipts. A changed subject, dependency, classification, policy, or head requires fresh affected evaluation.
