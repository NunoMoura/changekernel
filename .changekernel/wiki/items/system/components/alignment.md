...
| Observed current state | What retained Evidence and applicable Check results establish about a subject, environment and time. It is not an omniscient inventory of reality. |
...
Separate continuing constraints from future targets and deadlines. An accepted improvement target can be unmet without being an immediate violation. Interpret that distinction through adopted Wiki and Checks rather than a hidden Kernel business rule. External reality can change without a commit.

## Realization and coverage are independent

Report realization as established, contradicted, or not established within declared scope, using plain presentation such as met, not met or unknown. This is a derived explanation of Check/Evidence records, not another multi-valued Check-result primitive. Boolean false still distinguishes observed mismatch, inadequate Evidence and operational inability through feedback.

Report related work independently: which exact Changes claim to cover all or part of the outcome, a prerequisite, an investigation or an explicit target revision. Several Changes can contribute to one outcome and one Change to several outcomes. A backlog link is a coverage claim, not proof. Agents propose links; adopted Checks assess consequential claims; the backend retains their support. Similar names, a closed Change or generic passing Checks do not establish realization.
...
Realization and coverage judgments belong to explicitly selected Checks whose questions actually address those claims. The Kernel enforces record and execution integrity; it does not infer semantic success from formatting, lifecycle closure or an axis label. Rebuild views from retained records without rerunning models merely to render status. Exact identity proves neither completeness nor factual truth.
