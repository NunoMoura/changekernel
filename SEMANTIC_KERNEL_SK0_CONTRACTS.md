...
A released CodeWiki controller N installed outside this checkout governs each exact candidate and packet under protected-head policy. N records Decision, required Checks, Gate, confirmation, and immutable outcome Evidence without loading N+1 as this repository's Pi extension. The migration Receipt correction entered qualified SK1 candidate `5735315aa6d220115f033f863a4fc5c63ed2694b`; any later correction still requires another bounded candidate and may not silently waive a gate. Disposable qualification projects and credentials are cleaned after Evidence retention. After exact-subject qualification and explicit activation, immutable released N may dogfood this checkout while governing N+1; mutable candidate code never governs itself.
