...
export const DECISION_QUESTIONS = Object.freeze(([
	...
	["commitment-preservation", "Can retained commitments hold during pursuit and at the destination?", "Account for retained commitments and intermediate obligations separately from explicitly proposed revisions. A candidate cannot authorize its own waiver. Identify conflicts or unsafe intermediate conditions."],
	...
	["intent-fit", "Would the actual proposed effects credibly serve the stated purpose?", "Establish a credible connection between actual proposed effects and intent. Identify a broken causal connection or substituted objective; do not treat consistency alone as justified pursuit."],
...
export const DECISION_INPUTS = Object.freeze([
	...
	Object.freeze({name: "changekernel:decision:effects", type: "array", selection: "Backend-observed changed artifacts and actual proposed effects, not the producer's classification alone."}),
