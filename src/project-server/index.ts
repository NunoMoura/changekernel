...
export {
	...
	KB_TO_WIKI_BACKEND_STATE_ACTIVATION_PROTOCOL,
...
export {
	KB_TO_WIKI_MIGRATION_STAGE_IMPLEMENTATION_DIGEST,
	KB_TO_WIKI_MIGRATION_STAGE_PROTOCOL,
	assertStagedKbToWikiMigration,
	stageKbToWikiMigration,
	type KbToWikiConvertedTraceInput,
	type StageKbToWikiMigrationInput,
	type StagedKbToWikiMigration,
} from "./operations/kb-to-wiki-stage.ts";
export {
	KB_TO_WIKI_MIGRATION_ACTIVATION_PROTOCOL,
	...
	type KbToWikiMigrationActivationReceipt,
	type KbToWikiMigrationRestartInspection,
	type KbToWikiMigrationRestartPhase,
	type KbToWikiMigrationRollbackResult,
} from "./operations/kb-to-wiki-activate.ts";
export {
