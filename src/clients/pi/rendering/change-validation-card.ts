...
export function renderPiChangeValidationCard(
	...
	const lines = [
		...
		...optionalSectionLine(
			"Current pain",
			card.sections.problem.currentPain,
		),
		"",
		"Objective",
		card.sections.objective.text,
		`Rationale: ${card.sections.objective.rationale}`,
		...optionalSectionLine(
			"Desired outcome",
			card.sections.objective.desiredOutcome,
		),
		...listLines("Non-goals", card.sections.objective.nonGoals),
		"",
		"Agent opinion",
