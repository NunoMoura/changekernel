...
> = Object.freeze({
	...
	"decision.confirmed": definition([
		...
		"loop.record",
		TAIL,
		"exact Candidate and passed Gate bind current WorkState, accepted active Changes, and Knowledge heads",
		"reject",
		["candidate_confirmed_by", "confirmation_binds_gate_report"],
		"latest_valid",
	]),
	...
	"planning.delta_accepted": definition([
		"planning.delta_accepted",
		"planning.accept",
		TAIL,
		"exact Planning Candidate and passed Gate bind current Change, Knowledge, and Work Graph heads",
		"reject",
		["candidate_accepted_by", "planning_delta_updates_work_graph"],
		"latest_valid",
	]),
	"implementation.candidate_recorded": definition([
		...
		"loop.record",
		TAIL,
		"referenced active attempt is Implementation and exact Work Unit Candidate binds current Assignment, acceptance slice, Session receipts, and result tree",
		"reject",
		["attempt_has_candidate", "work_unit_realized_by_candidate"],
		"latest_valid",
	]),
	...
	"integration.candidate_admitted": definition([
		"integration.candidate_admitted",
		"integration.record",
		TAIL,
		"exact fresh passing Work Unit Candidate, custody, dependencies, bytes, and private lineage head match",
		"reject",
		["candidate_admitted_to_private_lineage", "private_lineage_has_receipt"],
		"append_history",
	]),
	"implementation.aggregate_frozen": definition([
		"implementation.aggregate_frozen",
		"integration.record",
		TAIL,
		"all required Work Units are gated and integrated with complete dependency and acceptance coverage",
		"reject",
		["change_has_frozen_implementation_aggregate"],
		"append_history",
	]),
	"delivery.applied": definition([
		"delivery.applied",
		"source.effect",
		TAIL,
		"current frozen aggregate has one exact passing Review and target-head CAS authority",
		"reject",
		["review_authorizes_delivery", "delivery_realizes_aggregate"],
		"terminal",
	]),
