...
async function planChange(root, input) {
	...
	return runWikiPlan({
		...
		workUnits: [
			{
				...
				acceptanceRequirementIds: [`REQ-${input.workUnitId}`],
		...
		acceptanceCoverage: [
			{obligationId: `REQ-${input.workUnitId}`, workUnitIds: [input.workUnitId]},
		],
		aggregateReviewRequirements: [
			{id: `AGR-${input.workUnitId}`, statement: input.acceptance, workUnitIds: [input.workUnitId]},
		],
		uiPreviewTargets: [],
