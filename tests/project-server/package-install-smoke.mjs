...
assert.equal(runtimeModule.RUNTIME_BUILD_SCHEMA_VERSION, "2.0.0");
assert.equal(typeof runtimeModule.createExecutablePluginManifest, "function");
assert.equal(typeof runtimeModule.createExecutablePluginInventory, "function");
