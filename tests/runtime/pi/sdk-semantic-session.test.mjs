							...
							? {
									candidate: {
										workUnits: [{
											...
											acceptanceRequirementIds: ["REQ-schema"],
											componentRefs: ["runtime"],
											pathScopes: ["src/runtime/**"],
											verification: ["npm test"],
											resourceRequirements: { capabilityIds: ["source.edit"], toolIds: ["node-test"], skillIds: [], custodyRequirements: ["private-workbench"], consentRequirements: ["source-mutation"], privacyClass: "internal", budgetClass: "standard" },
										}],
										dependencyEdges: [],
										knowledgeEffectCoverage: [],
										unchangedKnowledgeCoverage: [],
										acceptanceCoverage: [{obligationId: "REQ-schema", workUnitIds: ["WU-sdk"]}],
										aggregateReviewRequirements: [{id: "AGR-schema", statement: "Review exact schema.", workUnitIds: ["WU-sdk"]}],
										uiPreviewTargets: [],
